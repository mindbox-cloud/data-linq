...
namespace System.Data.Linq 
{
    ...
    public class DataContext : IDisposable 
	{
		...
		/// </summary>
		public void SubmitChanges(Action<string, Action> measureEnhancer)
		{
			CheckDispose();
			SubmitChanges(ConflictMode.FailOnFirstConflict, measureEnhancer);
		}
		...
		public virtual void SubmitChanges(ConflictMode failureMode, Action<string, Action> measureEnhancer)
		{
			CheckDispose();
			...
			try
			{
				...
				if (Transactions.Transaction.Current == null && provider.Transaction == null)
				{
					...
					try
					{
						...
						new ChangeProcessor(services, this).SubmitChanges(failureMode, measureEnhancer);
						AcceptChanges();
