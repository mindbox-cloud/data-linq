...
namespace Mindbox.Data.Linq.Mapping
{
	...
	public class MindboxMappingSource : AttributeMappingSource
	{
		public MindboxMappingSource(
			...
			Func<IEnumerable<string>> autogeneratedIdentityColumnsToOverrideProvider)
		{
			...
			AutogeneratedIdentityColumnsToOverrideProvider = autogeneratedIdentityColumnsToOverrideProvider;
		}

		internal MindboxMappingConfiguration Configuration { get; }
		public Dictionary<string, bool> DatabaseMigratedColumns { get; }
		internal Func<IEnumerable<string>> AutogeneratedIdentityColumnsToOverrideProvider { get; }
