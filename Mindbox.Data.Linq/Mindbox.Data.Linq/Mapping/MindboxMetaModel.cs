...
namespace Mindbox.Data.Linq.Mapping
{
	internal class MindboxMetaModel : AttributedMetaModel
	{
		...
		private readonly Func<IEnumerable<string>> autogeneratedIdentityColumnsToOverrideProvider;
			...
			: base(mappingSource, contextType)
		{
			...
			autogeneratedIdentityColumnsToOverrideProvider = mappingSource.AutogeneratedIdentityColumnsToOverrideProvider;
		}
		...
		internal bool ShouldOverrideAutogeneratedIdentity(string columnIdentifier)
		{
			return autogeneratedIdentityColumnsToOverrideProvider().Contains(columnIdentifier);
		}
