...
namespace Mindbox.Data.Linq.Mapping
{
	internal class MindboxMetaModel : AttributedMetaModel
	{
		...
		private readonly Func<IEnumerable<string>> autogeneratedIdentityColumnsOverrideProvider;
			...
			: base(mappingSource, contextType)
		{
			...
			autogeneratedIdentityColumnsOverrideProvider = mappingSource.AutogeneratedIdentityColumnsOverrideProvider;
		}
		...
		{
			return autogeneratedIdentityColumnsOverrideProvider().Contains(columnIdentifier);
		}
